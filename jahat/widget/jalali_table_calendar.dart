      ...
      itemBuilder: (context, index) {
        ...
        if (isTheSame(Jalali.now(), date)) {
          ...
          return _DayBox(
              ...
              textColor: AppColors.backgroundClolor,
        ...
        if (isSelected) {
          ...
          return _DayBox(
            date: date,
            onTap: widget.onDaySelected,
            boxColor: AppColors.backgroundClolor,
            border: Border.all(color: AppColors.foregroundColor, width: 2),
        ...
        return _DayBox(
          date: date,
          onTap: widget.onDaySelected,
          boxColor: AppColors.backgroundColor,
          textColor: Colors.black,
        );
      },
    );
